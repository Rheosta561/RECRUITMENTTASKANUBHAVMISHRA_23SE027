...
export default function Footer() {
  ...
  return (
    <footer className="border-t fixed bottom-0 left-0 right-0 bg-background mt-10">
      <div className="max-w-7xl mx-auto px-6 py-2 flex flex-col  justify-between items-center gap-3 text-sm text-muted-foreground">
        ...
        <div className="text-center md:text-left">
          <p className="text-base font-semibold text-foreground">Nex<span className="text-primary">D</span></p>
